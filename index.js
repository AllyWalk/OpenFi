...
(async () => { 
    ...
    const client = await createAuthenticatedClient({
        walletAddressUrl: "https://ilp.interledger-test.dev/openfiwallet", //Url cliente
        privateKey:'private.key',
        keyId: "e4e36fee-f41b-4db2-aa6a-ab21e5ddc68b", // KeyId del cliente
    });
...
// 1. Obtener una concesiÃ³n para un pago entrante  
 const sendingWalletAdress = await client.walletAddress.get( {
        url: "https://ilp.interledger-test.dev/openfiwalletsend" //Url remitente
    });

    const receivingWalletAdress = await client.walletAddress.get( {
        url:"https://ilp.interledger-test.dev/testdetest" //Url receptor
...
const outgoingPaymentGrant = await client.grant.request(
    ...
    },
    {
        ...
        interact: {
            start: [ "redirect" ], 
            method: "redirect",
        uri: "http://localhost/OpenFi", // Url de redireccion
        nonce: NONCE,
        },
    }
);
